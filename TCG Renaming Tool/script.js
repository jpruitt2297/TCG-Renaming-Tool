document.getElementById('generateBtn').addEventListener('click', async () => {
    ...
    if (modType1) {
        ...
        if (modType1 !== 'Dracunix_No_Name') {
            if (category1 == ('Playmats' || 'Comics')) {
                const objectsData1 = zip.folder('BepinEx/plugins/TextureReplacer/objects_data/accessories');
    ...
    if (modType2) {
        ...
        if (modType2 !== 'Dracunix_No_Name') {
            if (category2 == ('Playmats' || 'Comics')) {
                const objectsData2 = zip.folder('BepinEx/plugins/TextureReplacer/objects_data/accessories');
